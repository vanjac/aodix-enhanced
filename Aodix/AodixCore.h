...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
enum ADX_EVENT_TYPE : unsigned char
{
	EVT_NOT, EVT_PAT, EVT_JMP, // sized events
	EVT_MID, EVT_AUT, EVT_TMP, // unsized events
};
...
public:
	...
	void dsp_stop_playing_notes(int pos,int pat,int trk,bool check_muted,int deltaframe);
